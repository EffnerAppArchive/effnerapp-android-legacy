...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navController.addOnDestinationChangedListener((controller, destination, arguments) -> {
            ...
            // show labels and set home fragment checkable if we navigate back from the fragment
            if (destination.getId() != R.id.navigation_information && destination.getId() != R.id.navigation_timetable && destination.getId() != R.id.navigation_mvv) {
